...
import org.libsdl.app.SDLConstants;

/**
    SDL Activity
*/
public class SDLActivityComponent implements SDLConstants{
...
*/
     ...
     */
    @ActivityHook
    public static boolean dispatchKeyEvent(KeyEvent event, Activity mActivity) {
