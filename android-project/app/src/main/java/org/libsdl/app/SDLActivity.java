...
import static org.libsdl.app.SDLActivityComponent.*;
/**
 SDL Activity
 */
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mSDLMainFinished || mActivityCreated) {
            boolean allow_recreate = nativeAllowRecreateActivity();
            if (mSDLMainFinished) {
        ...
        {
            int run_count = nativeCheckSDLThreadCounter(); /* get and increment a native counter */
            if (run_count != 0) {
                boolean allow_recreate = nativeAllowRecreateActivity();
                if (allow_recreate) {
        ...
        nativeSetNaturalOrientation(SDLActivity.getNaturalOrientation());
    ...
    public void onBackPressed() {
        ...
        //
        boolean trapBack = nativeGetHintBoolean("SDL_ANDROID_TRAP_BACK_BUTTON", false);
        if (trapBack) {
